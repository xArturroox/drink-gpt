...
const OrderConfirmationModal: React.FC<OrderConfirmationModalProps> = ({ order, isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-lg p-6 w-full max-w-md shadow-xl border border-white/20 dark:border-gray-700/30">
